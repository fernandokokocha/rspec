...
RSpec.describe DirectorsController, :type => :controller do
  ...
  # DirectorsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all directors as @directors" do
      ...
      expect(assigns(:directors)).to eq([director])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested director as @director" do
      director = Director.create! valid_attributes
      get :show, {:id => director.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested director as @director" do
      director = Director.create! valid_attributes
      get :edit, {:id => director.to_param}, valid_session
      expect(assigns(:director)).to eq(director)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Director" do
        expect {
          post :create, {:director => valid_attributes}, valid_session
        }.to change(Director, :count).by(1)
      end

      it "assigns a newly created director as @director" do
        post :create, {:director => valid_attributes}, valid_session
        expect(assigns(:director)).to be_a(Director)
        expect(assigns(:director)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved director as @director" do
        post :create, {:director => invalid_attributes}, valid_session
        expect(assigns(:director)).to be_a_new(Director)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested director as @director" do
        director = Director.create! valid_attributes
        put :update, {:id => director.to_param, :director => valid_attributes}, valid_session
        expect(assigns(:director)).to eq(director)
      end
    ...
    describe "with invalid params" do
      it "assigns the director as @director" do
        director = Director.create! valid_attributes
        put :update, {:id => director.to_param, :director => invalid_attributes}, valid_session
        expect(assigns(:director)).to eq(director)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested director" do
      director = Director.create! valid_attributes
      expect {
        delete :destroy, {:id => director.to_param}, valid_session
      }.to change(Director, :count).by(-1)
    end
